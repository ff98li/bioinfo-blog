...
The p-values calculated by QLF and Limma methods exhibit a strong positive linear correlation, suggesting the similarity in the results of these two differential expression analyses.
Both of these two methods can capture a common subset of top hits;
this is consistent with the nearly identical clustering pattern in the two heatmaps.
